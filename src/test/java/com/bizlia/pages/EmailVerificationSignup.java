...
public class EmailVerificationSignup extends CommonActions {

	public EmailVerificationSignup(WebDriver driver, ExtentTest logger) // created WebDriver Constructor
	{
		super(driver, logger);
